! function (t) {
    try {
        ...
        function P(e) {
            ...
            for (var t = 0; t < f; t++) e.outputBuffer.getChannelData(0)[t] = t < a / 2 ? Module.getValue(s + 2 * t, "i16") / o : 0; - 1 == w && (w = m.currentTime)
        }
        ...
        function S(e) {
            w = -1, W(), Y("Loading libtimidity ... "), q(ce, function () {
                V(e, F, null)
            })
        }
            ...
            if (I = Module.ccall("mid_song_load", "number", ["number", "number"], [r, t]), rval = Module.ccall("mid_istream_close", "number", ["number"], [r]), 0 < (g = Module.ccall("mid_song_get_num_missing_instruments", "number", ["number"], [I])))
                for (var o = 0; o < g; o++) {
                    ...
                    ! function (n, r, o) {
                        ...
                        a.open("GET", r + o, !0), a.responseType = "arraybuffer", a.onerror = function () {
                            Y("Error: Cannot retrieve patch file " + r + o)
                        }, a.onload = function () {
                            var e, t;
                            200 == a.status ? (g--, FS.createDataFile("pat/", o, new Int8Array(a.response), !0, !0), MIDIjs.message_callback && 0 < g && MIDIjs.message_callback("Instruments to be loaded: " + g), Y("Instruments to be loaded: " + g), 0 == g && (e = Module.ccall("mid_istream_open_mem", "number", ["number", "number", "number"], [l, u.length, !1]), t = Module.ccall("mid_create_options", "number", ["number", "number", "number", "number"], [m.sampleRate, 32784, 1, 2 * f]), I = Module.ccall("mid_song_load", "number", ["number", "number"], [e, t]), Module.ccall("mid_istream_close", "number", ["number"], [e]), Module.ccall("mid_song_start", "void", ["number"], [I]), b = !0, p = m.createScriptProcessor(f, 0, 1), s = Module._malloc(2 * f), p.onaudioprocess = P, p.connect(m.destination), d = setInterval(W, _), W(), MIDIjs.message_callback && MIDIjs.message_callback("Playing: " + n), Y("Playing1: " + n + " ... song: " + I))) : Y("Error: Cannot retrieve patch file " + r + o + " : " + a.status)
                        }, a.send()
                    }(e, M + "pat/", a)
        ...
        function z() {
            var e = new Object; - 1 == w && (w = (new Date).getTime()), e.time = ((new Date).getTime() - w) / 1e3, e.status = "playing", MIDIjs.player_callback && MIDIjs.player_callback(e)
        }
        ...
        function Z(e, t) {
            $(), v = R(t),
                function (i, s) {
                    ...
                    w = -1, m.audioWorklet.addModule(M + k).then(function () {
        ...
        function ee(o, a, i) {
            var e;
            12 == (240 & o) >> 4 ? V(M + "../midi/init.midi?v=" + c, function (e, t, n) {
            ...
            }, function () {}) : ((e = new Object).type = "midi-message", e.status = o, e.a = a, e.b = i, A.port.postMessage(e))
        }

        function te(e, t, n) {
            A || ne(), "suspended" === m.state ? m.resume().then(function () {
                x.then(function () {
                    ee(e, t, n)
                })
            }) : x.then(function () {
        ...
        function ne(e) {
            var a;
            A || (m || (window.AudioContext = window.AudioContext || window.webkitAudioContext, m = new AudioContext), a = null, x = new Promise(function (e) {
                a = e
            }), m.audioWorklet.addModule(M + k).then(function () {
                A = new AudioWorkletNode(m, "midijs-audio-worklet");
                var e = new Object;
                e.type = "set-logging", e.logging = h, A.port.postMessage(e), A.connect(m.destination), A.port.onmessage = function (e) {
                    var t = e.data;
                ...
                }, V(M + "../midi/init-expander.midi?v=" + c, function (e, t, n) {
        ...
        function re(t, n, r, o, a) {
            var i = new XMLHttpRequest;
            i.open("GET", r + o, !0), i.responseType = "arraybuffer", i.onerror = function () {
                Y("Error: Cannot retrieve patch file " + r + o)
            }, i.onload = function () {
                var e;
        ...
        function ue(t, n) {
            m.audioWorklet.addModule(M + k).then(function () {
                var o = new AudioWorkletNode(m, "midijs-audio-worklet"),
                    e = new Object;
                e.type = "set-logging", e.logging = h, o.port.postMessage(e), o.port.onmessage = function (e) {
                    e = e.data;
        ...
        t.MIDIjs.set_logging = function (e) {
            ...
            "Microsoft Internet Explorer" == me.browserName && me.fullVersion < 10 ? t && t(-1) : q(ce, function () {
                V(e, Q, t)
            })
        }, t.MIDIjs.getDuration = t.MIDIjs.get_duration, de(E), t.MIDIjs.getFreqTable = function () {
            return E
            ...
            pe("startExpander")
        }, "WebAudioWorklet" == n ? (t.MIDIjs.get_duration = ue, t.MIDIjs.getDuration = ue, t.MIDIjs.pause = e, t.MIDIjs.resume = L, t.MIDIjs.play = Z, t.MIDIjs.stop = $, j = "audioMethod: WebAudioWorklet, sampleRate (Hz): " + m.sampleRate, t.MIDIjs.noteOn = function (e, t, n) {
            te(144 + e % 16, t, n)
        }, t.MIDIjs.midiMessage = te, t.MIDIjs.startExpander = ne, t.MIDIjs.setFreqTable = function (e) {
            var t, n = new Array(12);
            if (Array.isArray(e))
                if (128 == e.length)
                    for (t = 0; t < 128; t++) E[t] = 1e3 * e[t];
                else {
                ...
                if ((void 0 === o || isNaN(o) || o < 0 || 11 < o) && (o = 0), "detuned" == r)
                    ...
                    var s = new Array(12);
                    ae(s, Math.pow(5, .25)), ie(n, s, o), oe(E, n)
                } else if ("just" == r) {
                    s = new Array(12);
                    ...
                    r = new Array(12);
                    r[0] = 1, r[1] = 8 / 9 * Math.pow(2, .25), r[2] = 9 / 8, r[3] = Math.pow(2, .25), r[4] = 8 / 9 * Math.sqrt(2), r[5] = 9 / 8 * Math.pow(2, .25), r[6] = Math.sqrt(2), r[7] = 1.5, r[8] = 128 / 81, r[9] = Math.pow(8, .25), r[10] = 3 / Math.pow(8, .25), r[11] = 4 / 3 * Math.sqrt(2), ie(n, r, o), oe(E, n)
                }
            }
            return se({
                type: "set-freq-table",
        ...
        }) : "WebAudioAPI" == n ? (t.MIDIjs.pause = e, t.MIDIjs.resume = L, t.MIDIjs.play = function (e) {
            y = !1, B(), f = 8192, H(e)
        }, t.MIDIjs.stop = B, j = "audioMethod: WebAudioAPI, sampleRate (Hz): " + m.sampleRate + ", audioBufferSize (Byte): " + f, t.MIDIjs.noteOn = function ye(e, t, n) {
            Y("noteOn channel: " + e + " key: " + t + " velocity: " + n + " isEndless: " + y + " song: " + I), y || (B(), y = !0, f = 512, H(M + "../midi/init-expander.midi?v=" + c), setTimeout(function () {
                ye(e, t, n)
            }, 1e3), setTimeout(function () {
                ye(e, t, 0)
            }, 1500)), 0 != I && Module.ccall("mid_song_note_on", "void", ["number", "number", "number", "number"], [I, e, t, n])
        }) : j = "bgsound" == n ? (t.MIDIjs.play = X, t.MIDIjs.stop = J, "audioMethod: &lt;bgsound&gt;") : "object" == n ? (t.MIDIjs.play = function (e) {
            K();
        ...
        }, t.MIDIjs.stop = K, "audioMethod: &lt;object&gt;") : (t.MIDIjs.play = function (e) {}, t.MIDIjs.stop = function (e) {}, "audioMethod: No method found"), "Microsoft Internet Explorer" == me.browserName && "https:" == location.protocol.toLowerCase() && setTimeout(function () {
            X(G(M) + "../midi/silence.mid"), clearInterval(d)
        }, 1), -1 == location.href.indexOf("scorio.com") && -1 == location.href.indexOf("weblily.net") && -1 == location.href.indexOf("local") || "WebAudioWorklet" == n && ne(), t.MIDIjs.initError = null
    } catch (ve) {
